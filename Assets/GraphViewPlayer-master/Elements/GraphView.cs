...
namespace GraphViewPlayer
{
    public abstract class GraphView : VisualElement
    {
        ...
        public void DeleteElement(GraphElement graphElement)
        {
        ...
        public void DeleteElements(IEnumerable<GraphElement> graphElements)
        {
            foreach (var graphElement in graphElements)
                DeleteElement(graphElement);
        }
        #endregion
        ...
        protected internal abstract void ExecuteEdgeCreate(BaseEdge edge, BasePort output, BasePort input);
