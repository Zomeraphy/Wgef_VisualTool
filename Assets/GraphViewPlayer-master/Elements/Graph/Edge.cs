...
namespace GraphViewPlayer
{
    public class Edge : BaseEdge
    {
        ...
        private const int k_DefaultEdgeWidth = 3;
        private const int k_DefaultEdgeWidthSelected = 3;
        ...
        public int EdgeWidthSelected { get; set; } = k_DefaultEdgeWidthSelected;
        public Color ColorSelected { get; set; } = s_DefaultSelectedColor;
        public Color ColorUnselected { get; set; } = s_DefaultColor;
